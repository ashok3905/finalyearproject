...
const contacts = [
  { id: "arjun", name: "Arjun M.", role: "Student", online: true, last: "Sir, can we shift to 11?" },
  { id: "priya", name: "Priya S.", role: "Student", online: false, last: "Thank you sir!" },
  { id: "admin", name: "NeuroDrive Admin", role: "Admin", online: true, last: "New schedule available" },
];

const seed: Record<string, Msg[]> = {
  arjun: [
    { from: "them", text: "Sir, can we shift to 11 tomorrow?", time: "9:02 AM" },
    { from: "me", text: "Sure, see you at 11!", time: "9:05 AM" },
  ],
  priya: [{ from: "them", text: "Thank you sir!", time: "Yesterday" }],
  admin: [{ from: "them", text: "New schedule available in dashboard.", time: "Mon" }],
};
...
const InstructorChat = () => {
  ...
  const send = (e: React.FormEvent) => {
    ...
    setDraft("");
    setTimeout(() => {
      setChats((c) => ({ ...c, [activeId]: [...(c[activeId] || []), { from: "them", text: "Okay sir 👍", time: new Date().toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" }) }] }));
    }, 900);
  };
  ...
  return (
    <div className="max-w-6xl">
      <PageHeader title="Chat" subtitle="Message your students and admin" />
